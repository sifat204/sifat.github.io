...
<div style="display: flex; gap: 30px; flex-wrap: wrap; align-items: flex-start;">
  ...
  <a href="https://doi.org/10.1016/j.ecmx.2024.100550" target="_blank" style="color: #007cba; text-decoration: none;">
        ...
        <a href="{{ site.baseurl }}/assets/pdf/ECM.pdf" style="display: inline-block; padding: 10px 20px; background-color: #007cba; color: white; text-decoration: none; border-radius: 4px; font-weight: bold;">
          Download Paper
        </a>
      </div>
    </div>
...
<a href="{{ site.baseurl }}/assets/pdf/Hybrid_dryer.pdf"
   target="_blank"
   style="
